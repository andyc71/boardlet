...
enum DeleteDiagnosticsAlertType { case none, confirm, complete }
...
class SettingsViewModel: ObservableObject {
    ...
    @Published var logResult: Result<MFMailComposeResult, Error>? = nil
    @Published var showingBugEmail = false
    @Published var showingLogEmail = false
    @Published var showingFeatureEmail = false
    @Published var showMailBugAlert = false
    @Published var showMailLogAlert = false
    @Published var showMailFeatureAlert = false
    @Published var showShareSheet = false
    @Published var showCreditsView = false
    @Published var showIncludeExcludeView = false
    @Published var showDiagnosticView = false
    
    
    @Published var showAlertForDeleteDiagnosticLogs = false
