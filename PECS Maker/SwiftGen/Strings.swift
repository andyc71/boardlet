...
internal enum L10n {
  ...
  internal enum NoPhotosView {
    ...
    internal static let message = L10n.tr("Localizable", "NoPhotosView.message", fallback: "Start your project started by adding some photos.")
  }
  ...
  internal enum PageSizeSelectionView {
    /// Page Size
    internal static let title = L10n.tr("Localizable", "PageSizeSelectionView.title", fallback: "Page Size")
  }
  ...
  internal enum RatingAlert {
    ...
    internal static let message = L10n.tr("Localizable", "RatingAlert.message", fallback: "Your rating will help other users to find this app more easily.")
    /// No, Thanks
    internal static let noButton = L10n.tr("Localizable", "RatingAlert.noButton", fallback: "No, Thanks")
    /// Rate
    internal static let rateButton = L10n.tr("Localizable", "RatingAlert.rateButton", fallback: "Rate")
    /// Please Rate Easy PECS
    internal static let title = L10n.tr("Localizable", "RatingAlert.title", fallback: "Please Rate Easy PECS")
  }
  internal enum RatingPromptView {
    /// Maybe Later
    internal static let laterButton = L10n.tr("Localizable", "RatingPromptView.laterButton", fallback: "Maybe Later")
    /// No Thanks
    internal static let noButton = L10n.tr("Localizable", "RatingPromptView.noButton", fallback: "No Thanks")
    /// Rate
    internal static let rateButton = L10n.tr("Localizable", "RatingPromptView.rateButton", fallback: "Rate")
  }
