...
internal enum L10n {
  ...
  internal enum ClearSelectionsAlert {
    ...
    internal static let message = L10n.tr("Localizable", "ClearSelectionsAlert.message", fallback: "Clear selections and start a new design?")
    /// Clear Selections
  ...
  internal enum DeletePhotoAlert {
    ...
    internal static func message(_ p1: Int) -> String {
      return L10n.tr("Localizable", "DeletePhotoAlert.message", p1, fallback: "Remove %d photo(s) from your design?")
    }
  }
  ...
  internal enum FruitNames {
    ...
    /// cherry
    internal static let cherry = L10n.tr("Localizable", "FruitNames.cherry", fallback: "cherry")
    /// grapes
  ...
  internal enum PhotoSelectionView {
    ...
    internal static let deleteButton = L10n.tr("Localizable", "PhotoSelectionView.deleteButton", fallback: "Remove selected photos")
    /// Deselect All
  ...
  internal enum PreviewPage {
    ...
    /// Save or Print
    internal static let saveButton = L10n.tr("Localizable", "PreviewPage.saveButton", fallback: "Save or Print")
    /// Print
    internal static let title = L10n.tr("Localizable", "PreviewPage.title", fallback: "Print")
  }
  internal enum RenameTopicAlert {
    /// Design Title
    internal static let placeholder = L10n.tr("Localizable", "RenameTopicAlert.placeholder", fallback: "Design Title")
    /// Rename Design
    internal static let title = L10n.tr("Localizable", "RenameTopicAlert.title", fallback: "Rename Design")
  }
  internal enum Repo {
    /// New Design
    internal static let defaultTopicTitle = L10n.tr("Localizable", "Repo.defaultTopicTitle", fallback: "New Design")
  }
  ...
  internal enum TopicSelectionView {
    /// Create Design
    internal static let createDesignButton = L10n.tr("Localizable", "TopicSelectionView.createDesignButton", fallback: "Create Design")
    /// Done
    ...
    internal static let noTopicsMessage = L10n.tr("Localizable", "TopicSelectionView.noTopicsMessage", fallback: "Click Create Design to start a new PECS template.")
    /// My Designs
    internal static let title = L10n.tr("Localizable", "TopicSelectionView.title", fallback: "My Designs")
    internal enum DeleteTopicAlert {
      ...
      /// Delete Design
      internal static let title = L10n.tr("Localizable", "TopicSelectionView.DeleteTopicAlert.title", fallback: "Delete Design")
    }
  }
}
